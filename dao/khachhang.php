 ...
 */
function kh_insert($hoten,$matkhau,$kichhoat,$hinh,$email){
    $sql = "INSERT INTO khachhang(hoten,matkhau,kichhoat,hinh,email) VALUES(?,?,?,?,?)";
    pdo_execute($sql, $hoten,$matkhau,$kichhoat,$hinh,$email);
}
