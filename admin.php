...
<aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="admin/images/logo.png" width="100px" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="admin/images/logo.png" width="50px" alt="Logo"></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Quan ly </a>
...
function exist_param($page) {
  ...
  if (exist_param("ad_home")) {
      $view_page = "admin/quanlyalbum.php";
  }
  else if (exist_param("qlkh")) {
    $view_page = "admin/qlkh.php";
}
  ...
  else if (exist_param("home")) {
    $view_page = "admin/main.php";
}
